...
print("Updating 1M records took:  \t\t\t", update_time_1 - update_time_0)
...
print("Aggregate 1M of 100 record batch took:\t", agg_time_1 - agg_time_0)
...
print("Deleting 1M records took:  \t\t\t", delete_time_1 - delete_time_0)