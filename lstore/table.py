...
class Table:
    ...
    def __init__(self, name: str, num_columns: int, primary_key_col: int):
        ...
        self.page_ranges: list[PageRange] = [PageRange(self.num_columns, self.page_directory, self.rid_generator)]
    ...
    def insert_record(self, columns: list[int]) -> bool:
    ...
    def get_latest_column_values(self, primary_key: int, projected_columns_index: list[int]):
