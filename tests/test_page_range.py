...
class TestCumulativePageRange(unittest.TestCase):
    ...
    def test_invalidate_record(self):
        ...
        page_range: PageRange = PageRange(self.num_cols, page_dir, self.rid_generator, self.table_name, self.bufferpool, True)
        record = [1, 2, 3]
        ...
        tail1_indir_value = tail_page.get_column_of_record(INDIRECTION_COLUMN, slot_num_tail1)
        slot_num_tail2 = self.rid_generator.get_slot_num(tail_rid2)
        tail2_indir_value = tail_page.get_column_of_record(INDIRECTION_COLUMN, slot_num_tail2)
    ...
    def test_is_full(self) -> None:
        page_range: PageRange = PageRange(self.num_cols, self.page_directory, self.rid_generator, self.table_name, self.bufferpool, True)
